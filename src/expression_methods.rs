...
/// this trait.
pub trait CitextOrNullableCitext {}

impl CitextOrNullableCitext for Citext {}
impl CitextOrNullableCitext for Nullable<Citext> {}

impl<T> CitextExpressionMethods for T
where
    T: Expression,
    T::SqlType: CitextOrNullableCitext,
{
}
